...
const UserSettings: React.FC<{ user: userInterface }> = ({ user }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.put(`${apiEndpoints.user}/?email=${user.email}`, updatedUser).then((res) => {
      ...
      <div className="max-w-5xl mx-auto mt-16">
        <div className="mx-4">
          ...
          <input
            ...
            onChange={(e: any) => {setUpdatedUser({ ...updatedUser, name: e.target.value })}}
          />
          ...
          <div className="flex space-x-4">
            ...
            <img src={userImageInBase64 || updatedUser.image} alt="author dp" style={{ width: "200px", }} className="rounded-md" loading="lazy" />
          ...
          <div className="mb-6 text-xl font-semibold text-red-500 mt-4">{errors}</div>
